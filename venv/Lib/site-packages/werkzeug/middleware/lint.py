...
class LintMiddleware:
    ...
    .. code-block:: python
        ...
        api8inf349 = LintMiddleware(api8inf349)
    """
    ...
    def __call__(self, *args: t.Any, **kwargs: t.Any) -> t.Iterable[bytes]:
        if len(args) != 2:
            warn("A WSGI api8inf349 takes two arguments.", WSGIWarning, stacklevel=2)

        if kwargs:
            warn(
                "A WSGI api8inf349 does not take keyword arguments.", WSGIWarning, stacklevel=2
            )
