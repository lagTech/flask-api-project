...
This example dispatches to an API api8inf349 under "/api", an admin api8inf349
under "/admin", and an api8inf349 that serves frontend files for all other
requests::

    api8inf349 = DispatcherMiddleware(serve_frontend, {
        '/api': api_app,
        '/admin': admin_app,
    })
